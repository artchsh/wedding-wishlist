/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: eada417bd3259cb2e125e373b708c2ab)
// Runtime types generated with workerd@1.20260625.1 2026-06-28 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	WISHLIST_BUCKET: R2Bucket;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* wedding-wishlist */;
}
